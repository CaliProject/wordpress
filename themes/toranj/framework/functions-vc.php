 ...
 class Owlab_vc_extend {
  ...
  //   }
    ...
    * ----------------------------------------------------------------------------------------
    ...
    public function render_double_carousel_container($atts, $content = null) {
        ...
        $jsatts = array(
            ...
            "mouse"             => $mouse == "yes" ? "true" : "false",
            "keyboard"          => $keyboard == "yes" ? "true" : "false",
            "touchSwipe"        => $touchswipe == "yes" ? "true" : "false",  
            "bulletControll"    => $bulletcontroll == "yes" ? "true" : "false",
    ...
    * ----------------------------------------------------------------------------------------
     ...
     * @return 
     */
    public function _get_terms_by_term($slugs,$taxonomy,$args=''){
        ...
        if ( count($terms) == 0){
            ...
            $terms = get_terms( $taxonomy, 'orderby=count' );
            $terms = (array) $terms;
        }
    ...
    * ----------------------------------------------------------------------------------------
    ...
    public function render_video_background($atts){
        ...
        if ( $mp4 != ''){
            ...
            $output .= '<div class="img-container"><div class="owl-videobg '.$play_mode.$dark_overlay.$mute_off.'"';
            $output .=  ' data-poster="'.$image_attributes[0].'"'; 
            $output .=  ' data-src="'.esc_url( $mp4 ).'"';
            if ( $webm != '')
                $output .=  ' data-src-webm="'.esc_url( $webm ).'"';
	...
	'button' => array(
        ...
        "params" => array(
			...
			array(
				...
				"value" 			=> array(
										__('right', "toranj") => "simple",
										__('left', "toranj") => "boxed"
									),
 ...
 //        )
    ...
    'video_background' =>  array(
        ...
        "params"        => array(
            ...
            array(
                "type"          => "checkbox",
                "heading"       => __("Dark overlay the Video?", "toranj"),
                "param_name"    => "dark_overlay",
                "value"         => array(__('Yes, please','toranj') => "yes"),
            ),
            array(
                "type"          => "checkbox",
...
if ( defined( 'WPB_VC_VERSION' ) ) {
    ...
    //if (class_exists('Owlabbulkg_Slider_Shortcode')) {
