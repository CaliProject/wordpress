    ...
    <?php else: ?>      
	    ...
	    <div class="horizontal-folio">';
	        ...
	        <div class="gp-item <?php echo $item_overlay['parent_class'] ?>">
	            <a href="<?php echo $img_url; ?>" class="lightbox-gallery-item set-bg" title="<?php echo $img_data['title'] ?>">
	                <img src="<?php echo $thumb_url[0] ?>" alt="<?php echo $img_data['title'] ?>" class="img-responsive">
